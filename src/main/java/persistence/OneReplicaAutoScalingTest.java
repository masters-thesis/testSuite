 ...
 */
@Entity
@Table(name="one_replica_auto_scaling_tests")
public class OneReplicaAutoScalingTest {
    ...
    public OneReplicaAutoScalingTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, String ipAddressReplicaTwo, long successfulConnectionsReplicaTwo, long failedConnections, long testDurationInMs) {
    ...
    public OneReplicaAutoScalingTest(){}
