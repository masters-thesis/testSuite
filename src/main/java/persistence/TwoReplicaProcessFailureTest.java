 ...
 */
@Entity
@Table(name="two_replica_process_failure_tests")
public class TwoReplicaProcessFailureTest {
    ...
    public TwoReplicaProcessFailureTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, String ipAddressReplicaTwo, long successfulConnectionsReplicaTwo, long failedConnections, long testDurationInMs) {
    ...
    public TwoReplicaProcessFailureTest(){}
