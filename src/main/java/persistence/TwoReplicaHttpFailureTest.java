 ...
 */
@Entity
@Table(name="two_replica_http_failure_tests")
public class TwoReplicaHttpFailureTest {
    ...
    public TwoReplicaHttpFailureTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, String ipAddressReplicaTwo, long successfulConnectionsReplicaTwo, long failedConnections, long testDurationInMs) {
    ...
    public TwoReplicaHttpFailureTest(){}
