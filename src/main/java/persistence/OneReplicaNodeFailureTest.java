 ...
 */
@Entity
@Table(name="one_replica_node_failure_tests")
public class OneReplicaNodeFailureTest {
    ...
    public OneReplicaNodeFailureTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, long failedConnections, long testDurationInMs) {
    ...
    public OneReplicaNodeFailureTest(){}
