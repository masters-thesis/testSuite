 ...
 */
@Entity
@Table(name="two_replica_node_failure_tests")
public class TwoReplicaNodeFailureTest {
    ...
    public TwoReplicaNodeFailureTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, String ipAddressReplicaTwo, long successfulConnectionsReplicaTwo, long failedConnections, long testDurationInMs) {
    ...
    public TwoReplicaNodeFailureTest(){}
