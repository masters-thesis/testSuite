 ...
 */
@Entity
@Table(name="one_replica_process_failure_tests")
public class OneReplicaProcessFailureTest {
    ...
    public OneReplicaProcessFailureTest(String platform, String version, String ipAddressReplicaOne, long successfulConnectionsReplicaOne, long failedConnections, long testDurationInMs) {
    ...
    public OneReplicaProcessFailureTest(){}
